  ...
  return (
    <div id="editUserModal" aria-hidden="true" className={classNameModal}>
      <div className="relative w-full max-w-2xl h-full md:h-auto">
        <form
          className="relative bg-white rounded-lg shadow light:bg-gray-700"
          onSubmit={(e) => {
            e.preventDefault();
            onSubmitForm();
          }}
        >
          <div className="flex justify-between items-start p-4 rounded-t border-b light:border-gray-600">
          ...
          <div className="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 light:border-gray-600">
            <button
              type="submit"
